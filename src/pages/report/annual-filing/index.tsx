...
const AnnualFilingReportTable = () => {
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs:12}}>
        <TableLayout
          title='Annual Filing Report'
          columns={columns}
          rows={rows}
          addHref='/report/annual-filing/add'
          deleteHref='/report/annual-filing/delete'
        />
      </Grid>
    </Grid>
  )
...
export default AnnualFilingReportTable
